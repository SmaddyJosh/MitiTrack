    ...
    return (
        <nav className="navbar">
            ...
            <div className="nav-right">
                ...
                <div className="nav-icons" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {token ? (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <span style={{ fontWeight: 'bold', fontSize: '0.85rem', color: 'var(--dark-text)' }}>
                                {user?.firstName}
                            </span>
                            <button 
                        ...
                        <Link to="/login" className="icon-circle" title="Sign In">
